...
class commentReply(models.Model):
    ...
    replyTo = models.ForeignKey('self', on_delete=models.CASCADE, blank=True, null=True, related_name='reply', verbose_name="پاسخ برای")
...
class comments(models.Model):
    ...
    userId = models.ForeignKey( User,on_delete=models.CASCADE,related_name='user' ,verbose_name="آیدی کاربر")
    
    postId = models.ForeignKey('allPosts', on_delete=models.CASCADE, related_name='comment', verbose_name= "آیدی پست")
    
    commentReplies = models.ForeignKey(commentReply,on_delete=models.CASCADE,related_name='replies',verbose_name="آیدی کامنت")
...
class allPosts(models.Model):
    ...
    comments = models.ForeignKey(comments, on_delete=models.CASCADE, related_name='post', verbose_name= "کامنت ها")
...
class albums(models.Model):
    ...
    ogImage = models.ImageField(upload_to='images/',help_text= "Image size must be at 1200*630")
...
class bazi100Team(models.Model):
    ...
    position = models.CharField(max_length=80,choices=POSITION_CHOICES,blank=True,null=True,verbose_name="پست کاری")
    
    expertise = models.CharField(max_length=160,verbose_name="حرفه")
...
class choice(models.Model):
    ...
    polls = models.ForeignKey(polls,on_delete=models.CASCADE,verbose_name="نظرسنجی")
    ...
    class Meta:
               constraints = [
            models.UniqueConstraint(fields=['polls', 'user'], name='unique_user_choice')
        ]
