    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ogImage', models.ImageField(help_text='Image size must be at 1200*630', upload_to='images/', verbose_name='عکس انتشار')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.CharField(blank=True, choices=[('developer', 'developer'), ('author', 'author'), ('advertisement', 'advertisement'), ('cameraman', 'cameraman'), ('soicials', 'socials')], max_length=80, null=True, verbose_name='پست کاری')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replyTo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply', to='blog.commentreply', verbose_name='پاسخ برای')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likeCount', models.IntegerField(default=0, verbose_name='تعداد لایک\u200cها')),
                ('commentReplies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='blog.commentreply', verbose_name='آیدی کامنت')),
                ('postId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='blog.allposts', verbose_name='آیدی پست')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polls', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.polls', verbose_name='نظرسنجی')),
        ...
        migrations.AddField(
            model_name='allposts',
            name='comments',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post', to='blog.comments', verbose_name='کامنت ها'),
        ),
        migrations.AddField(
            model_name='allposts',
            name='tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True, verbose_name='تاریخ  انتشار')),
                ('image', models.ImageField(help_text=' Image file must be lowerthan 200kb, preferably 100kb , Use it in WEBP format and transparent', null=True, upload_to='images/', verbose_name='کاور آلبوم')),
                ('ogImage', models.ImageField(help_text='Image size must be at 1200*630', upload_to='images/')),
